...
import { Firestore, collection, collectionData, CollectionReference, doc, setDoc, deleteDoc } from '@angular/fire/firestore';
...
export class AgentService {
    ...
    async upsert(orgId: string, agent: Agent): Promise<void> {
        ...
        await setDoc(ref as any, { ...agent, Uid: id }, { merge: true });
    }
